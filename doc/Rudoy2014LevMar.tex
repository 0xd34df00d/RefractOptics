...
погрешность определения длины волны зависит от самой длины волны. Данная ситуация
...
практических приложений. На примере широко применяемого алгоритма
...
оптимизации имеет те же свойства (такие, как скорость сходимости), что и
исходный алгоритм.
Приводятся результаты на экспериментальных данных по измерению параметров
...
в иллюстративных целях погрешности определения $x$ и $y$ приняты
одинаковыми.

Пользуясь вышеуказанными соображениями,
...
Расстояние \eqref{eq:dist0} выражается через линеаризованную функцию
...
Минимизируя это выражение, находим расстояние от
