...
\begin{abstract}
  ...
  резонатора, показывающие преимущество предложенного функционала, по крайней мере,
...
к некоторым <<истинным>> значениям. Показано, что, по крайней мере, для малых
объемов выборок предложенный функционал дает лучшие приближения.
