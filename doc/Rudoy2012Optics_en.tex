...
\begin{abstract}
  ...
  model stability, which shows the dependency of the error in determining the parameters
  of the generated models on the variation of the data in the learning set. This criteria
  is used directly to determine the error of the model parameters, which is of interest
...
measured samples. More complex case of non-linear regression, including the case
of independent variables measured inexactly, as well as all samples having
...
composition differ only slightly. Thus, the error in determining the
$n(\lambda)$ function parameters and its dependency on the measurement errors
...
is investigated. The problem of determining the stability of model parameters
