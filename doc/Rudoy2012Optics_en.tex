...
The dispersion surfaces of each coefficient of each polymer are shown in table \ref{tabl:res_even}.

\begin{table}[h]
  \centering
  \footnotesize
  \caption{Dispersion for \eqref{eq:res_0}.}
...
first and second coefficients in the region of interest. At the same time, their dispersion
depends on the dispersion of the refraction index almost linearly.
