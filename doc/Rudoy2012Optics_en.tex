...
(normalized by the value of that parameter) and the standard deviation of the corresponding
$j$-th feature vector component (again, normalized by the value of that components).
...
According to \cite{Vatunin05} for the following presentation:
\[
...
\[
  \delta_1 = \frac{| \overline{\sigma}_a - D(a) |}{D(a)},
\]
\[
  \delta_2 = \frac{| \overline{\sigma}_b - D(b) |}{D(b)}.
\]
